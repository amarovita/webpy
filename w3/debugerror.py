...
<h3>INPUT</h3>
$:dicttable(w3.input(_unicode=False))

<h3 id="cookie-info">COOKIES</h3>
$:dicttable(w3.cookies())
...
<div id="explanation">
  <p>
    You're seeing this error because you have <code>w3.config.debug</code>
...
def djangoerror():
    ...
    t = djangoerror_r
    globals = {'ctx': w3.ctx, 'web':web, 'dict':dict, 'str':str, 'prettify': prettify}
...
def debugerror():
    ...
    """
    return w3._InternalError(djangoerror())
...
def emailerrors(to_address, olderror, from_address=None):
    ...
    def emailerrors_internal():
        ...
        path = w3.ctx.path
        request = w3.ctx.method + ' ' + w3.ctx.home + w3.ctx.fullpath
